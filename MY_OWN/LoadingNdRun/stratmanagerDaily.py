...
class StrategyManager():
    ...
    def __init__(self, symbol, start_date, end_date,data):
        self.df = self._extract_data(symbol, start_date, end_date,data)
        self.sharpe = 0

    # Extract data
    def _extract_data(self, symbol, start_date, end_date,data):
